...
class AbstractTest {
    ...
    private sealed class DomainObject: Abstract.Object<UiObject, DomainToUiObject>(){
        class Success(private val textCombined:String): DomainObject(){
            override fun map(mapper: DomainToUiObject): UiObject {
                TODO("Not done yet")
            }
        }
    ...
    private interface DomainToUiObject: Abstract.Mapper
